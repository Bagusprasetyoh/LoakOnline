...
/**
 * Created by Huthut on 12/2/2017.
 */

public class AppConfig {
    // Server user login url
    public static String URL_LOGIN = "http://192.168.48.1/LoakOnline/login.php";
    public static String URL_KATEGORI = "http://192.168.48.1/LoakOnline/kategori.php";
    ...
    public static String URL_TRANSAKSI = "http://192.168.48.1/LoakOnline/Transaksi.php";
    public static String URL_UPDATE_TRANSAKSI = "http://192.168.48.1/LoakOnline/update_Transaksi.php";
    public static String URL_DAFTARALLTRANSAKSI = "http://192.168.48.1/LoakOnline/AllTransaksi.php";
    public static String URL_DETAILTRANSAKSI = "http://192.168.48.1/LoakOnline/daftarTransaksi.php";
    public static String URL_EDITDETAILBARANG = "http://192.168.48.1/LoakOnline/EditDetailTransaksi.php";
